...
class _FoodManagementScreenState extends State<FoodManagementScreen> {
  ...
  Future<void> guardarAlimento() async {
    ...
    _showDialog("Éxito", "Alimento guardado correctamente.");
  }

  Future<void> eliminarAlimento(String id) async {
    await FirebaseFirestore.instance.collection('alimentos').doc(id).delete();
    _showDialog("Éxito", "Alimento eliminado correctamente.");
  }
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  child:
                      Text("Guardar Alimento", style: TextStyle(fontSize: 18)),
                ),
              ],
            ),
          ),
